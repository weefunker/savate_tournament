...
Fighter.create!(club: arr_club.sample, fighter_age: rand(16..55), fighter_height:  rand(100..150), fighter_weight:  rand(30..55), fighter_gender: gender, fighter_experience: arr_exp.sample, fighter_skill: arr_skills.sample, fighter_name: gender == 'Male' ? Faker::Name.male_first_name + " " + Faker::Name.last_name : Faker::Name.female_first_name + " " + Faker::Name.last_name  )
